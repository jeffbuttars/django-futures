# Ensure we get the local copy of django-futures instead of what's on the standard path
import os
import sys
...
version = release = django_futures.version
...
latex_documents = [
    ('documentation', 'django-futures.tex', 'DjangoFutures Documentation',
     'DjangoFutures', 'manual', False),
    ]
